...
func (vm *VM) registerSqliteDatabasePrimitives(dbClass *Class) {
	...
	dbClass.AddClassMethod1(vm.Selectors, "open:", func(vmPtr interface{}, recv Value, pathVal Value) Value {
		v := vmPtr.(*VM)
	...
	dbClass.AddClassMethod0(vm.Selectors, "openMemory", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
	...
	dbClass.AddMethod0(vm.Selectors, "close", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
	...
	dbClass.AddMethod1(vm.Selectors, "execute:", func(vmPtr interface{}, recv Value, sqlVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod2(vm.Selectors, "execute:with:", func(vmPtr interface{}, recv Value, sqlVal, paramsVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod1(vm.Selectors, "query:", func(vmPtr interface{}, recv Value, sqlVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod2(vm.Selectors, "query:with:", func(vmPtr interface{}, recv Value, sqlVal, paramsVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod1(vm.Selectors, "queryRow:", func(vmPtr interface{}, recv Value, sqlVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod2(vm.Selectors, "queryRow:with:", func(vmPtr interface{}, recv Value, sqlVal, paramsVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod1(vm.Selectors, "queryAll:", func(vmPtr interface{}, recv Value, sqlVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod2(vm.Selectors, "queryAll:with:", func(vmPtr interface{}, recv Value, sqlVal, paramsVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod1(vm.Selectors, "prepare:", func(vmPtr interface{}, recv Value, sqlVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod1(vm.Selectors, "pragma:", func(vmPtr interface{}, recv Value, nameVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod2(vm.Selectors, "pragma:set:", func(vmPtr interface{}, recv Value, nameVal, valVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "enableWAL", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "beginTransaction", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "commitTransaction", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "rollbackTransaction", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "path", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "isClosed", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return False
	...
	dbClass.AddMethod0(vm.Selectors, "lastInsertId", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod1(vm.Selectors, "tableExists:", func(vmPtr interface{}, recv Value, nameVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "tables", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "version", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod2(vm.Selectors, "migrate:version:", func(vmPtr interface{}, recv Value, sqlVal, versionVal Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
	...
	dbClass.AddMethod0(vm.Selectors, "migrationVersion", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		dbObj := v.getSqliteDB(recv)
		if dbObj == nil {
			return v.newFailureResult("Not a SqliteDatabase")
...
func (vm *VM) registerSqliteStatementPrimitives(stmtClass *Class) {
	...
	stmtClass.AddMethod0(vm.Selectors, "execute", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
	...
	stmtClass.AddMethod1(vm.Selectors, "executeWith:", func(vmPtr interface{}, recv Value, paramsVal Value) Value {
		v := vmPtr.(*VM)
		stmtObj := v.getSqliteStmt(recv)
		if stmtObj == nil {
			return v.newFailureResult("Not a SqliteStatement")
	...
	stmtClass.AddMethod0(vm.Selectors, "query", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		stmtObj := v.getSqliteStmt(recv)
		if stmtObj == nil {
			return v.newFailureResult("Not a SqliteStatement")
	...
	stmtClass.AddMethod1(vm.Selectors, "queryWith:", func(vmPtr interface{}, recv Value, paramsVal Value) Value {
		v := vmPtr.(*VM)
		stmtObj := v.getSqliteStmt(recv)
		if stmtObj == nil {
			return v.newFailureResult("Not a SqliteStatement")
	...
	stmtClass.AddMethod0(vm.Selectors, "close", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		stmtObj := v.getSqliteStmt(recv)
		if stmtObj == nil {
			return v.newFailureResult("Not a SqliteStatement")
	...
	stmtClass.AddMethod0(vm.Selectors, "sql", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		stmtObj := v.getSqliteStmt(recv)
		if stmtObj == nil {
			return v.newFailureResult("Not a SqliteStatement")
...
func (vm *VM) registerSqliteRowsPrimitives(rowsClass *Class) {
	...
	rowsClass.AddMethod0(vm.Selectors, "next", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
	...
	rowsClass.AddMethod1(vm.Selectors, "columnAt:", func(vmPtr interface{}, recv Value, indexVal Value) Value {
		v := vmPtr.(*VM)
		rowsObj := v.getSqliteRows(recv)
		if rowsObj == nil {
			return v.newFailureResult("Not a SqliteRows")
	...
	rowsClass.AddMethod1(vm.Selectors, "columnNamed:", func(vmPtr interface{}, recv Value, nameVal Value) Value {
		v := vmPtr.(*VM)
		rowsObj := v.getSqliteRows(recv)
		if rowsObj == nil {
			return v.newFailureResult("Not a SqliteRows")
	...
	rowsClass.AddMethod0(vm.Selectors, "asDict", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		rowsObj := v.getSqliteRows(recv)
		if rowsObj == nil {
			return v.newFailureResult("Not a SqliteRows")
	...
	rowsClass.AddMethod0(vm.Selectors, "columns", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		rowsObj := v.getSqliteRows(recv)
		if rowsObj == nil {
			return v.newFailureResult("Not a SqliteRows")
	...
	rowsClass.AddMethod0(vm.Selectors, "columnCount", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		rowsObj := v.getSqliteRows(recv)
		if rowsObj == nil {
			return v.newFailureResult("Not a SqliteRows")
	...
	rowsClass.AddMethod0(vm.Selectors, "close", func(vmPtr interface{}, recv Value) Value {
		v := vmPtr.(*VM)
		rowsObj := v.getSqliteRows(recv)
		if rowsObj == nil {
			return v.newFailureResult("Not a SqliteRows")
